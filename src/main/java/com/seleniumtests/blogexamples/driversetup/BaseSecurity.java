...
public class BaseSecurity extends BaseClassOnDemandDriverSetupWithProxy {
    ...
    private static final String TARGET = "http://qa.portal-ui-mock.sdwan.novitas.internal.colt.net/";


    private static ClientApi clientApi = new ClientApi(ZAP_ADDRESS, ZAP_PORT, ZAP_API_KEY);
    ...
    public static void spiderTarget(String targetURL) throws InterruptedException, ClientApiException {
        String application_base_url = TARGET; // Example code to start and synchronize the spider scan.private static void startSpiderScan()
        System.out.println("Spider : {}"+ application_base_url);

        // Start spider scan

        System.out.println("apiResponse : {}"+  clientApi.spider.scan(targetURL, null, null, null, null));
